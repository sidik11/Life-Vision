                  ...
                  <div className="relative w-full h-[510px] rounded-xl overflow-hidden shadow-inner border border-emerald-300 bg-slate-900 shrink-0">
                    ...
                    <div className="absolute top-[316px] left-[38px] right-[32px] z-10 flex flex-col gap-[3px] font-sans">
                      ...
                      <div className="flex items-center text-[9.5px] leading-none">
                        ...
                        <span className="font-extrabold text-[#0f172a] truncate max-w-[160px]">{s.id}</span>
                      </div>
                      ...
                      <div className="flex items-center text-[9.5px] leading-none">
                        ...
                        <span className="font-bold text-[#1e293b] mr-1.5">:</span>
                        <span className="font-extrabold text-[#0f172a] truncate max-w-[160px]">{s.department}</span>
                      </div>
                      ...
                      <div className="flex items-center text-[9.5px] leading-none">
                        ...
                        <span className="font-bold text-[#1e293b] mr-1.5">:</span>
                        <span className="font-extrabold text-[#0f172a] truncate max-w-[160px]">{s.phone || '+91 9416362914'}</span>
                      </div>
                      ...
                      <div className="flex items-center text-[9.5px] leading-none">
                        ...
                        <span className="font-bold text-[#1e293b] mr-1.5">:</span>
                        <span className="font-extrabold text-[#0f172a] truncate max-w-[160px]">{s.joinDate || '2026-01-01'}</span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="relative w-[340px] h-[510px] rounded-2xl overflow-hidden shadow-2xl border-2 border-emerald-500 bg-slate-900 shrink-0">
                  ...
                  <div className="absolute top-[316px] left-[38px] right-[32px] z-10 flex flex-col gap-[3px] font-sans">
                    ...
                    <div className="flex items-center text-[9.5px] leading-none">
                      ...
                      <span className="font-bold text-[#1e293b] w-[72px] shrink-0">Employee ID</span>
                      <span className="font-bold text-[#1e293b] mr-1.5">:</span>
                      <span className="font-extrabold text-[#0f172a] truncate max-w-[160px]">{selectedCardStaff.id}</span>
                    </div>
                    ...
                    <div className="flex items-center text-[9.5px] leading-none">
                      ...
                      <span className="font-bold text-[#1e293b] w-[72px] shrink-0">Department</span>
                      <span className="font-bold text-[#1e293b] mr-1.5">:</span>
                      <span className="font-extrabold text-[#0f172a] truncate max-w-[160px]">{selectedCardStaff.department}</span>
                    </div>
                    ...
                    <div className="flex items-center text-[9.5px] leading-none">
                      ...
                      <span className="font-bold text-[#1e293b] w-[72px] shrink-0">Contact No.</span>
                      <span className="font-bold text-[#1e293b] mr-1.5">:</span>
                      <span className="font-extrabold text-[#0f172a] truncate max-w-[160px]">{selectedCardStaff.phone || '+91 9416362914'}</span>
                    </div>
                    ...
                    <div className="flex items-center text-[9.5px] leading-none">
                      ...
                      <span className="font-bold text-[#1e293b] w-[72px] shrink-0">Joining Date</span>
                      <span className="font-bold text-[#1e293b] mr-1.5">:</span>
                      <span className="font-extrabold text-[#0f172a] truncate max-w-[160px]">{selectedCardStaff.joinDate || '2026-01-01'}</span>
                    </div>
                  </div>
                </div>
              </div>
